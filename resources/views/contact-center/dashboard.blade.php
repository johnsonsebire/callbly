                    ...
                    <div class="card card-flush h-md-100">
                        ...
                        <div class="card-body d-flex flex-column justify-content-end pe-0">
                            ...
                            <div class="progress h-8px bg-light-primary">
                                <div class="progress-bar bg-primary" role="progressbar" style="width: {{ $creditUsagePercent }}%" aria-valuenow="{{ $creditUsagePercent }}" aria-valuemin="0" aria-valuemax="100"></div><div class="card-title"></div><div class="card-title"></div>
                            </div><div class="card-title"></div><div class="card-title"></div>
                            <!--end::Progress-->
                        </div><div class="card-title"></div><div class="card-title"></div>
                        <!--end::Card body-->
                        ...
                        <div class="card-body pt-2 pb-4 d-flex flex-wrap align-items-center">
                            ...
                            <div class="d-flex flex-column content-justify-center flex-row-fluid">
                                ...
                                <div class="d-flex fw-semibold align-items-center">
                                    <!--begin::Bullet-->
                                    <div class="bullet w-8px h-3px rounded-2 bg-success me-3"></div><div class="card-title"></div><div class="card-title"></div>
                                    <!--end::Bullet-->
                                    <!--begin::Label-->
                                    <div class="text-gray-500 flex-grow-1 me-4">Successful Calls</div><div class="card-title"></div><div class="card-title"></div>
                                    <!--end::Label-->
                                    <!--begin::Stats-->
                                    <div class="fw-bolder text-gray-700 text-xxl-end">{{ $successfulCalls }}</div><div class="card-title"></div><div class="card-title"></div>
                                    <!--end::Stats-->
                                </div><div class="card-title"></div><div class="card-title"></div>
                                <!--end::Label-->
                                <!--begin::Label-->
                                <div class="d-flex fw-semibold align-items-center my-3">
                                    <!--begin::Bullet-->
                                    <div class="bullet w-8px h-3px rounded-2 bg-danger me-3"></div><div class="card-title"></div><div class="card-title"></div>
                                    <!--end::Bullet-->
                                    <!--begin::Label-->
                                    <div class="text-gray-500 flex-grow-1 me-4">Failed Calls</div><div class="card-title"></div><div class="card-title"></div>
                                    <!--end::Label-->
                                    <!--begin::Stats-->
                                    <div class="fw-bolder text-gray-700 text-xxl-end">{{ $failedCalls }}</div><div class="card-title"></div><div class="card-title"></div>
                                    <!--end::Stats-->
                                </div><div class="card-title"></div><div class="card-title"></div>
                                <!--end::Label-->
                            </div><div class="card-title"></div><div class="card-title"></div>
