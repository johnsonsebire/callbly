                ...
                <div class="row mb-4">
                    <div class="col-md-12">
                        ...
                        <div class="card-title">
                            ...
                            <p class="text-muted">Create reusable message templates for quick sending</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="px-2 py-3 bg-light rounded border mb-3">
                                    <p class="mb-0" id="preview-content">Preview will appear here...</p>
                                </div>
                                <p class="text-muted small">This is how your template will look with variables shown as codes. When sending, variables will be replaced with actual values.</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function updateCounts() {
            ...
            // Update preview
            previewContent.textContent = content || 'Preview will appear here...';
        }
