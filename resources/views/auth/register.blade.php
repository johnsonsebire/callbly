...
@section('content')
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text">Password must be at least 8 characters and contain letters (both uppercase and lowercase), numbers, and symbols.</div><div class="card-title"></div><div class="card-title"></div>
                        </div><div class="card-title"></div><div class="card-title"></div>
