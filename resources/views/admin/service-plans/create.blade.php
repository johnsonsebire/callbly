                ...
                <div class="card">
                    <div class="card-header border-0 pt-5">
                        <div class="card-title">
                            <h2 class="fw-bold">Create New Service Plan</h2>
                        </div>
                        ...
                        <form action="{{ route('admin.service-plans.store') }}" method="POST">
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <select name="type" id="type" class="form-select form-select-solid" required>
                                        ...
                                        <option value="voice" {{ old('type') === 'voice' ? 'selected' : '' }}>Voice</option>
                                        <option value="contact-center" {{ old('type') === 'contact-center' ? 'selected' : '' }}>Contact Center</option>
                                        <option value="virtual-number" {{ old('type') === 'virtual-number' ? 'selected' : '' }}>Virtual Numbers</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row mb-6">
                                <div class="col-lg-12">
                                    ...
                                    <textarea name="description" id="description" class="form-control form-control-solid" 
                                              rows="3" placeholder="Enter plan description" required>{{ old('description') }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-6">
                                <div class="col-lg-4">
                                    ...
                                    <div class="form-text">Amount will be converted to base currency (GHS) for storage</div>
                                </div>
                                <div class="col-lg-4">
                                    ...
                                    <input type="number" name="validity_days" id="validity_days" class="form-control form-control-solid" 
                                           value="{{ old('validity_days') }}" placeholder="30" min="1" required>
                                </div>
                                <div class="col-lg-4">
                                    ...
                                    <input type="number" name="units" id="units" class="form-control form-control-solid" 
                                           value="{{ old('units') }}" placeholder="1000" min="0" required>
                            ...
                            <div class="d-flex justify-content-end">
                                ...
                                <button type="submit" class="btn btn-primary">Create Service Plan</button>
                            </div>
                        </form>
                    </div>
                </div>
